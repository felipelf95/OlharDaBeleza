...
using OlharDaBeleza.Controllers;
...
namespace OlharDaBeleza.Models
{
    public class EnderecoesController : Controller
    {
        ...
        public EnderecoesController(OlharDaBelezaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Cep,Estado,Cidade,Logradouro,NumeroCasa,Complemento")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Cep,Estado,Cidade,Logradouro,NumeroCasa,Complemento")] Endereco endereco)
        {
            if (id != endereco.Id)
            {
                return NotFound();
